...
export default function PhoneScreen() {
  ...
  const handleSendOTP = async () => {
    ...
    setLoading(false)
    console.log('OTP Response:', { success, error })
    if (success) {
...
const styles = StyleSheet.create({
  ...
  devLink:         { marginTop: 24, paddingVertical: 12, alignItems: 'center' },
  devLinkText:     { color: '#6B7280', fontSize: 12, textDecorationLine: 'underline' },
})